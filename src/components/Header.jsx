      ...
      <div className="container">
        <div className="header-content">
          ...
          <div className="header-actions">
            <div className={`search-wrapper${searchActive ? ' active' : ''}`} title="Search Bitskill">
              <input
                ...
                aria-label="Search"
              />
              <button className="search-icon" onClick={openSearch} aria-label="Open search">
            ...
            <div className="auth-buttons">
              <a className="btn btn-outline" href="login.html">Login</a>
              <a className="btn btn-outline" href="signup.html">Sign Up</a>
            </div>
          </div>
        </div>
      </div>
